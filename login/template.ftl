...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <main class="${properties.kcLoginMain!}">
      <img src="${url.resourcesPath}/img/esnet-logo.png" alt="ESnet" class="esnet-logo">
      ...
      <div class="${properties.kcLoginMainBody!}">
        ...
        <div class="${properties.kcLoginMainFooter!}">
            <p class="kc-esnet-info-text">If you have lost your phone and/or need your OTP Authenticator reset, please email <a href="mailto:inf-request@es.net">inf-request@es.net</a>, which will open a ServiceNow Ticket.</p>
            <@loginFooter.content/>
        </div>
    </main>
  </div>
</div>
<img src="${url.resourcesPath}/img/doe-logo.png" alt="U.S. Department of Energy" class="doe-logo">
</body>
</html>
</#macro>
